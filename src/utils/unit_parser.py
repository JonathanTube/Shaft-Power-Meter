...
class UnitParser:
    ...
    @staticmethod
    def parse_power(power: float, system_unit: int, shrink: bool = False) -> tuple[float, str]:
    ...
    @staticmethod
    def parse_torque(torque: float, system_unit: int, shrink: bool = False) -> tuple[float, str]:
    ...
    @staticmethod
    def parse_thrust(thrust: float, system_unit: int, shrink: bool = False) -> tuple[float, str]:
