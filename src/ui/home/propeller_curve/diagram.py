    ...
    async def update_sps_points(self):
        ...
        while self.task_running:
            try:
                ...
                sps_percent_rpm_of_mcr = round(gdata.configSPS.speed / self.rpm_of_mcr * 100, 2)
                sps_percent_power_of_mcr = round(gdata.configSPS.power / self.power_of_mcr * 100, 2)
                ...
                sps2_percent_rpm_of_mcr = round(gdata.configSPS2.speed / self.rpm_of_mcr * 100, 2)
                sps2_percent_power_of_mcr = round(gdata.configSPS2.power / self.power_of_mcr * 100, 2)
