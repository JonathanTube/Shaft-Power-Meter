...
class PropellerConfLimitCurve(CustomCard):
    ...
    def save_data(self):
        ...
        gdata.speed_of_torque_load_limit = self.ps.rpm_right_of_torque_load_limit_curve
        gdata.power_of_torque_load_limit = self.ps.bhp_right_of_torque_load_limit_curve
