...
class SystemConf:
    def __init__(self):
        ...
        if self.last_ship_info is None:
            self.last_ship_info = ShipInfo.create(
    ...
    def __create_settings_card(self):
        ...
        self.display_thrust = ft.Switch(
            ...
            on_change=lambda e: self.__set_system_settings(
                'display_thrust', e.control.value)
        )
        ...
        self.amount_of_propeller_radios = ft.RadioGroup(
            ...
            on_change=lambda e: self.__set_system_settings(
                'amount_of_propeller', e.control.value)
        )
    ...
    def __create_factor_conf_card(self):
        self.shaft_outer_diameter = ft.TextField(
            ...
            on_change=lambda e: self.__set_factor_conf(
                'bearing_outer_diameter_D', e.control.value)
        )
        ...
        self.shaft_inner_diameter = ft.TextField(
            ...
            on_change=lambda e: self.__set_factor_conf(
                'bearing_inner_diameter_d', e.control.value)
        )
        ...
        self.sensitivity_factor_k = ft.TextField(
            ...
            on_change=lambda e: self.__set_factor_conf(
                'sensitivity_factor_k', e.control.value)
        )
        ...
        self.elastic_modulus_E = ft.TextField(
            ...
            suffix_text="Gpa",
            on_change=lambda e: self.__set_factor_conf(
                'elastic_modulus_E', e.control.value)
        )
        ...
        self.poisson_ratio_mu = ft.TextField(
            ...
            on_change=lambda e: self.__set_factor_conf(
                'poisson_ratio_mu', e.control.value)
        )
